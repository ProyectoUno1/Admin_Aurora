...
//End point para historico de graficas de psicologos
router.get('/stats/psychologists/history', verifyFirebaseToken, verifyAdminPrivileges, async (req, res) => {
    try {
        ...
        snapshot.forEach(doc => {
            ...
            if (timestamp && timestamp.toDate) {
                ...
                console.warn(` Documento sin timestamp válido:`, doc.id);
            }
        });
